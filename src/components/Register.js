       ...
       <> 
            {
                ...
                <button className="login-button" type="submit">{loading ? <Spinner /> : <p>Đăng kí</p>}</button>
                ...
                :
                <div className="login bg-green-600 rounded-xl">
                   
                        <BiUserCheck className="text-[80px] text-white block translate-x-[20%]" />
                        <div className="bg-green-600 w-full text-white font-medium text-2xl text-center mb-1 py-2 rounded-md">ĐĂNG KÍ THÀNH CÔNG</div>
                   
                    <p onClick={() => handleActive(2)} className="underline font-medium text-xl cursor-pointer text-white">Đăng nhập</p>
                </div>
            }
            {
